...
class Accounting extends Admin_Controller
{
    ...
    protected function account_validation()
    {
        ...
        $this->form_validation->set_rules('account_name', translate('account_name'), array('trim', 'required', array(
            'unique_account_name',
    ...
    public function voucher_head()
    {
        if ($_POST) {
            ...
            $this->form_validation->set_rules('voucher_head', translate('name'), array(
                'trim',
                'required',
    ...
    public function voucher_head_edit()
    {
        if ($_POST) {
            ...
            $this->form_validation->set_rules('voucher_head', translate('name'), array('trim', 'required', array(
                'unique_voucher_head',
    ...
    public function voucher_save()
    {
        if ($_POST) {
            ...
            if ($type == 'deposit') {
                $this->form_validation->set_rules('roll', translate('roll'), 'trim|required');
            }
    ...
    public function head_wise_income_repots()
    {
        if (!get_permission('accounting_reports', 'is_view')) {
            access_denied();
        }
        if ($_POST) {
            ...
            $this->data['results'] = $this->accounting_model->getHeadWiseIncomeExpenseRepots($branchID, $start, $end,$voucher_head_id, 'deposit');
        }
        $this->data['title'] = translate('financial_reports');
        $this->data['sub_page'] = 'accounting/head_wise_income_repots';
        $this->data['main_menu'] = 'accounting_repots';
        $this->load->view('layout/index', $this->data);
    }
    ...
    public function head_wise_expense_repots()
    {
        if (!get_permission('accounting_reports', 'is_view')) {
            access_denied();
        }
        if ($_POST) {
            ...
            $end = date("Y-m-d", strtotime($daterange[1]));
            $this->data['daterange'] = $daterange;
            $this->data['results'] = $this->accounting_model->getHeadWiseIncomeExpenseRepots($branchID, $start, $end,$voucher_head_id,'expense');
        }
        $this->data['title'] = translate('financial_reports');
        $this->data['sub_page'] = 'accounting/head_wise_expense_repots';
        $this->data['main_menu'] = 'accounting_repots';
        $this->load->view('layout/index', $this->data);
    }
