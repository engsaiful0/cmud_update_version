...
class Certificate extends Admin_Controller
{
    ...
    public function get_name_by_bmdc_reg_no()
{
    $bmdc_reg_no = $this->input->post('bmdc_reg_no', true);
    $csrf_token = $this->input->post($this->security->get_csrf_token_name(), true);

    // Replace this with actual logic to fetch the name from the database
    $data = $this->certificate_model->get_name_by_bmdc_reg_no($bmdc_reg_no);
    ...
    public function bmdc_reg_no_load()
    {
        ...
        $data_bmdc_reg_no = array();
        foreach ($sql as $value) {
            array_push($data_bmdc_reg_no, $value->bmdc_reg_no);
        }
        echo json_encode($data_bmdc_reg_no);
    }
    ...
    public function edit($id = '')
    {
        ...
        $this->data['certificate'] = $this->certificate_model->getDataById($id);
        $this->data['title'] = translate('certificate') . " " . translate('templete');
        $this->data['headerelements'] = array(
            'css' => array(
                'css/certificate.css',
