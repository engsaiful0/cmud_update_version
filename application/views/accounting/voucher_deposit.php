	...
	<div class="tabs-custom">
		...
		<div class="tab-content">
			<div id="list" class="tab-pane active">
                <?php $this->load->view('accounting/voucher_deposit_filters'); ?>
                <div id="deposit-filter-error" class="alert alert-danger" role="alert" style="display:none"></div>
                <div id="deposit-filter-loading" role="status" style="display:none">Loading deposits...</div>
                <div id="deposit-results" aria-live="polite">
                    <?php $this->load->view('accounting/voucher_deposit_list'); ?>
                </div>
			</div>
			<?php if (get_permission('deposit', 'is_add')) { ?>
				<div class="tab-pane" id="create">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('ref'); ?>/Serial No</label>
						<div class="col-md-6">
...
<script src="<?= base_url('assets/js/voucher-deposit-filters.js') ?>"></script>
