	...
	<div class="tabs-custom">
		...
		<div class="tab-content">
			<div id="list" class="tab-pane active">
                <?php $this->load->view('accounting/voucher_expense_filters'); ?>
                <div id="expense-filter-error" class="alert alert-danger" role="alert" style="display:none"></div>
                <div id="expense-filter-loading" role="status" style="display:none">Loading expenses...</div>
                <div id="expense-results" aria-live="polite">
                    <?php $this->load->view('accounting/voucher_expense_list'); ?>
                </div>
			</div>
			<?php if (get_permission('expense', 'is_add')) { ?>
...
<script src="<?= base_url('assets/js/voucher-expense-filters.js') ?>"></script>
