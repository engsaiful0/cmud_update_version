			...
			<div class="tab-pane active" id="create">
				...
				<?php if (is_superadmin_loggedin()): ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							echo form_dropdown("branch_id", $arrayBranch, $expense['branch_id'], "class='form-control' id='branch_id' 
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						...
						echo form_dropdown("account_id", $accounts_list, $expense['account_id'], "class='form-control' id='account_id' 
								data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
						?>
						<span class="error"></span>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						...
						echo form_dropdown("pay_via", $payvia_list, $expense['pay_via'], "class='form-control' id='payment_type_id' data-plugin-selectTwo data-width='100%'
				...
				if ($expense['pay_via'] == 1 || $expense['pay_via'] == 6) {
					$bkash_transaction_contianer_display = 'none';
					$rocket_transaction_contianer_display = 'none';
					$nogod_transaction_contianer_display = 'none';
					$bank_details_contianer_display = 'none';
				} else if ($expense['pay_via'] == 2) {
					$bkash_transaction_contianer_display = 'block';
				} else if ($expense['pay_via'] == 3) {
					$rocket_transaction_contianer_display = 'block';
				} else if ($expense['pay_via'] == 4) {
					$nogod_transaction_contianer_display = 'block';
				} else if ($expense['pay_via'] == 5) {
				...
				<div class="form-group" style="display: <?php echo $bkash_transaction_contianer_display ?>" id="bkash_transaction_contianer">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="bkash_transaction_number" value="<?= $expense['bkash_transaction_number'] ?>" />
					</div>
				</div>
				<div class="form-group" style="display: <?php echo $rocket_transaction_contianer_display ?>;" id="rocket_transaction_contianer">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="rocket_transaction_number" value="<?= $expense['rocket_transaction_number'] ?>" />
					</div>
				</div>
				<div class="form-group" style="display: <?php echo $nogod_transaction_contianer_display ?>;" id="nogod_transaction_contianer">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="nogod_transaction_number" value="<?= $expense['nogod_transaction_number'] ?>" />
					</div>
				</div>
				<div class="form-group" style="display: <?php echo $bank_details_contianer_display ?>;" id="bank_details_contianer">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="bank_details" value="<?= $expense['bank_details'] ?>" />
					</div>
				</div>
				<div class="form-group">
