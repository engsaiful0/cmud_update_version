<div class="row">
		...
		<div class="col-md-5">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group mb-md">
						<label class="control-label"><?php echo translate('Serial No'); ?></label>
						<input placeholder="Enter Serial No" type="number" class="form-control" name="serial_no" id="serial_no" />
						<span class="error"><?= form_error('serial_no') ?></span>
					</div>
				</div>
	...
	<?php if (get_permission('voucher_head', 'is_view')): ?>
		<div class="col-md-<?php if (get_permission('voucher_head', 'is_add')) {
								echo "7";
							} else {
								echo "12";
							} ?>">
	...
	<div class="zoom-anim-dialog modal-block modal-block-primary mfp-hide" id="modal">
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="form-group mb-md">
					<label class="control-label"><?php echo translate('serial_no'); ?> <span class="required">*</span></label>
					<input type="text" class="form-control" name="serial_no" id="serial_no_data" />
					<span class="error"></span>
				</div>
			</div>
	...
	function getVoucherHead(id) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#serial_no_data').val(data.serial_no);
				mfp_modal('#modal');
			}
		});
	}
