	...
	<div class="row">
		<div class="col-md-4">
			<?php if (get_permission('student_quantity_pie_chart', 'is_view')) { ?>
				<div class="<?php echo get_permission('weekend_attendance_inspection_chart', 'is_view') ? 'col-md-12 col-lg-12 col-xl-12' : 'col-md-12'; ?>">
					<section class="panel pg-fw">
						<div class="panel-body">
							...
							<div class="widget-col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right mt-md text-primary"><?php
										...
										$this->db->where("student.session_id", get_session_id());
										if (!empty($school_id))
											$this->db->where('branch_id', $school_id);
