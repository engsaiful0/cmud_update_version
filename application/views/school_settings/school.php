...
<div class="row">
    ...
    <div class="col-md-9">
        <section class="panel">
            <header class="panel-heading">
                <h4 class="panel-title"><i class="fas fa-school"></i> <?=translate('institute_setting')?></h4>
            </header>
            <?php echo form_open_multipart('school_settings' . get_request_url(), array('class' => 'form-horizontal  frm-submit-data')); ?>
                <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="mt-lg">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?=translate('institute_name')?> <span class="required">*</span></label>
                                    <div class="col-md-6">
                                ...
                                <div style="display: none;" class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="radio-custom radio-success radio-inline mb-xs">
                                            ...
                                            <label for="astatus_1"><?=translate('batch_wise')?></label>
                                        </div>
                                ...
                                <div style="display: none;" class="form-group mb-md">
                    ...
                    <section style="display: none;" class="panel pg-fw">
                        <div class="panel-body">
