	...
	<div class="col-md-12">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title">Fee Allocation</h4>
			</header>
			...
			<div class="panel-body">
				<div class="row mb-sm">
					...
					<table class="table table-bordered">
						...
						<?php
						$subjects = $this->db->select('*')->get('subject')->result();
						$serial = 1;
						...
						?>
							<tr>
								...
								<td>
									<input type="hidden" name="subject_id[]" value="<?php echo $subject->id ?>" class="form-control">
									<input name="course_fee[]" class="form-control">
								</td>
							</tr>
						<?php
						}
