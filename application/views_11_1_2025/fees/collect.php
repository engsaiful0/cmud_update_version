			...
			<?php if ($invoice['status'] != 'total') : ?>
				<div id="collect_fees" class="tab-pane">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" oninput="payable_amount(this.value)" class="form-control" value="<?= number_format($total_balance, 2, '.', '') ?>" name="amount" id="feeAmount" value="" autocomplete="off" />
							<span class="error"></span>
						</div>
					</div>
					<script>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" placeholder="Discount Amount" class="form-control" id="discount_amount" oninput="calculate_payable()" name="discount_amount" autocomplete="off" />
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" class="form-control" name="payable" id="payable" value="<?= number_format($total_balance, 2, '.', '') ?>" autocomplete="off" />
							<span class="error"></span>
						</div>
					</div>
			...
			<?php if ($invoice['status'] != 'total') : ?>
				<div id="fully_paid" class="tab-pane">
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?= translate('discount') ?></label>
						<div class="col-md-6">
							<input type="text" class="form-control" id="discount_amount" oninput="calculate_payable(this.value)" name="discount_amount" autocomplete="off" />
							<span class="error"></span>
						</div>
					</div>
					<div class="form-group">
