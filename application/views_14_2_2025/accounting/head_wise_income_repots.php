...
$income_heads = $this->db->select('id, name')->where('type', 'income')->from('voucher_head')->get()->result_array();
...
<?php if (isset($results)): ?>
    <section class="panel appear-animation" data-appear-animation="<?php echo $global_config['animations']; ?>" data-appear-animation-delay="100">
        <header class="panel-heading">
            <h4 class="panel-title"><i class="fas fa-list-ol"></i>Head Wise <?php echo translate('income') . " " . translate('repots'); ?></h4>
        </header>
        <div class="panel-body">
